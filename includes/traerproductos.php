...
<div class="container-fluid">
    ...
    while ($datos = $sql->fetch_array()) {
        ...
        echo '  <div class="card col-md-4 mx-1 my-2" style="width: 18rem;">                                
                                <img data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="' . $descripcion . '" class="card-img-top mx-auto mt-1 img-fluid h-50" src="../assets/img/productos/' . $idpro . '.webp" alt="Card image cap">                            
