        ...
        <div class="row my-auto">
            ...
            <div class="col-sm-12 col-md-5 col-lg-6 my-2 justify-content-center align-content-end">
                <div class="input-group ">
                    <input id="filtprod" type="text" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="Buscar Producto" oninput="validarInput(this)" onkeydown="filtroproducto(event)">
