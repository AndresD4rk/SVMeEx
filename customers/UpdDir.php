...
<body>
    ...
    <main class="mb-5">
        ...
        <main class="container-fluid mt-2">
            ...
            ?>
                <form id="formid" action="process/editdir2.php" method="POST">
                    <div class="mb-4">
                    ...
                    <div class="col-8 mx-auto">
                        <div class="row">
                            <div class="col-6 mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" name="id" value="<?php echo $iddir ?>" required hidden>
                                <input type="text" id="lat" class="form-control" name="lat" value="<?php echo $lat ?>" required hidden>
                                <input type="text" id="lng" class="form-control" name="lng" value="<?php echo $lng ?>" required hidden>
                                <input type="text" id="dir" class="form-control" name="direccion" value="<?php echo $nomdir ?>" required>
                            </div>
                            <div class="col-6 mb-3 mt-3">
                                <label for="exampleInputEmail1" class="form-label ">Municipio</label>
                                <input type="text" id="mun" class="form-control" name="municipio" value="<?php echo $muni ?>" required>
                            </div>
                            <div class="col-12 mb-3 mt-3">
                                <label for="exampleInputEmail1" class="form-label ">Detalle</label>
                                <input type="text" class="form-control" name="detalle" value="<?php echo $det ?>">
                            </div>
                            <div class="col-12 mb-2" id="map" style="height: 45vh;">
                            </div>
                        ...
                        <select id="select-categoria" class="form-select" aria-label="Default select example" name="SelRol" required>                            
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-end mb-2"><a onclick="formid.submit()" class="btn btn-outline-success"><b>Actualizar</b></a></div>
                            </div>
