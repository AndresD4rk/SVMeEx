...
<div  class="col-6 mb-3 mt-3">
    ...
    <input type="text" class="form-control" id="PriNom" aria-describedby="emailHelp" placeholder="Ingresa tu primer nombre">
  </div>
  <div  class="col-6 mb-3 mt-3">
    <label for="exampleInputEmail1" class="form-label ">Segundo Nombre</label>
    <input type="text" class="form-control" id="SegNom" aria-describedby="emailHelp" placeholder="Ingresa tu segundo nombre">
  </div>
  <div  class="col-6 mb-3 mt-3">
    <label for="exampleInputEmail1" class="form-label ">Primer Apellido</label>
    <input type="text" class="form-control" id="PriNom" aria-describedby="emailHelp" placeholder="Ingresa tu primer apellido">
  </div>
  <div  class="col-6 mb-3 mt-3">
    <label for="exampleInputEmail1" class="form-label ">Segundo Apellido</label>
    <input type="text" class="form-control" id="SegNom" aria-describedby="emailHelp" placeholder="Ingresa tu segundo apellido">
  </div>
</div>
